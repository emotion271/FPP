...
class AlexNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.cbam1 = CBAM(35, 64, 16)
        self.cbam2 = CBAM(17, 192, 16)
        self.cbam3 = CBAM(17, 384, 16)
        self.cbam4 = CBAM(17, 256, 16)
        self.cbam5 = CBAM(8, 256, 16)
        '''
